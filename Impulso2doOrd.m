...
impulse(GSA1,GSA2,GPO)
title('Respuesta al impulso Sistemas sobre amortiguados - varia p');
ylabel('Amplitud');
xlabel('Tiempo');
legend('C(t) p1=1 p2=15;','C(t) p1=1 p2=3','C(t) 1er orden' );
...
impulse(GSA1,GSA2)
title('Respuesta al impulso Sistemas criticamente amortiguados - varia p');
ylabel('Amplitud');
xlabel('Tiempo');
...
[num,dem]=zp2tf(z,p,k)
GSubA3=tf(num,dem)
impulse(GSubA1,GSubA2,GSubA3)
title('Respuesta al impulso - varia parte real de polos (w=+-3i)')
ylabel('Amplitud')
xlabel('Tiempo')
...
GSubA3=tf(num,dem)
impulse(GSubA1,GSubA2,GSubA3)
title('Respuesta al impulso - varia parte imaginaria de polos Sigma=1')
ylabel('Amplitud')
xlabel('Tiempo')
...
impulse(GSubA,GCA,GSA)
title('Respuesta al impulso 3 casos')
ylabel('Amplitud')
xlabel('Tiempo')
legend('CSubA(t) Wd=3, Sigma=2','GCA(t) p=2','CSA(t) p1=1, p2=2');